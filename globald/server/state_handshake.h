...
#ifndef __ZELOS_GLOBALD_SERVER_STATE_HANDSHAKE_HPP__
#define __ZELOS_GLOBALD_SERVER_STATE_HANDSHAKE_HPP__
...
#endif //__ZELOS_GLOBALD_SERVER_STATE_HANDSHAKE_HPP__
