...
#ifndef __ZELOS_GLOBALD_SERVER_SERVER_H__
#define __ZELOS_GLOBALD_SERVER_SERVER_H__
...
protected:
    ...
    virtual void OnRemoveConnection (const uint32_t connID, const uint8_t state);
...
#endif  // __ZELOS_GLOBALD_SERVER_SERVER_H__
