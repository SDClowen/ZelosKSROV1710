...
#ifndef __ZELOS_AGENTD_SERVER_SERVER_H__
#define __ZELOS_AGENTD_SERVER_SERVER_H__
...
public:
    ...
    void setCloseCallback (const boost::function<void () > &fn);
...
private:
    ...
    Service *m_service;
    boost::function<void () > m_close_fn;
};

#endif // __ZELOS_AGENTD_SERVER_SERVER_H__
