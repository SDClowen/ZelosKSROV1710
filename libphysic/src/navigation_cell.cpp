...
namespace phy
{
    ...
    NavigationCell::ClassifyPath (const size_t prevCell, const size_t curCell, const Line &path,
                                  bool dirVDown, bool dirHLeft, bool dirPrefH, Coord *inter) const
    {
