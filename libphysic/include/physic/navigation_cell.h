...
#ifndef __ZELOS_LIBPHYSIC_PHYSIC_NAVIGATIONCELL_H__
#define __ZELOS_LIBPHYSIC_PHYSIC_NAVIGATIONCELL_H__
...
namespace phy
{
     ...
     *  The links can between cells of the same area of between cells of different areas adjecents
     *	to each other.
     *
...
#endif //__ZELOS_LIBPHYSIC_PHYSIC_NAVIGATIONCELL_H__
