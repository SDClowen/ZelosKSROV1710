...
#ifndef __ZELOS_LIBPHYSIC_PHYSIC_MODEL_MESH_COLLISION_H__
#define __ZELOS_LIBPHYSIC_PHYSIC_MODEL_MESH_COLLISION_H__
...
#endif //__ZELOS_LIBPHYSIC_PHYSIC_MODEL_MESH_COLLISION_H__
