...
#ifndef __ZELOS_LIBPHYSIC_PHYSIC_NAVIGATION_MESH_H__
#define __ZELOS_LIBPHYSIC_PHYSIC_NAVIGATION_MESH_H__
...
namespace phy
{
    ...
    public:
        ...
        bool resolveMotion (const Coord &beg, const Coord &end,
...
#endif //__ZELOS_LIBPHYSIC_PHYSIC_NAVIGATION_MESH_H__
