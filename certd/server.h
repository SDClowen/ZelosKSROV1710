...
#ifndef __ZELOS_CERTD_SERVER_H__
#define __ZELOS_CERTD_SERVER_H__
...
private:
    ...
    void OnConfigure (const std::map<std::string, std::string> &config_entries);
...
#endif // __ZELOS_CERTD_SERVER_H__
