...
#ifndef __ZELOS_GAMED_CHARACTERD_STATE_HANDSHAKE_H__
#define __ZELOS_GAMED_CHARACTERD_STATE_HANDSHAKE_H__
...
#endif // __ZELOS_GAMED_CHARACTERD_STATE_HANDSHAKE_H__
