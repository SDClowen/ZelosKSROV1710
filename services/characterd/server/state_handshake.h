...
#ifndef __ZELOS_SERVICES_CHARACTERD_SERVER_STATE_HANDSHAKE_H__
#define __ZELOS_SERVICES_CHARACTERD_SERVER_STATE_HANDSHAKE_H__
...
#endif // __ZELOS_SERVICES_CHARACTERD_SERVER_STATE_HANDSHAKE_H__
