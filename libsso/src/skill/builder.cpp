...
namespace sso
{
    ...
    enum SKILL_DEFINITION
    {
        ...
        BUILDER_CONVERT_HEALTH = 1684891508,
        ...
        BUILDER_CAST_CONDITION = 1919250787,
    ...
    SkillBuilder::SkillBuilder ()
    {
        ...
        m_builder_table[BUILDER_ATTACK_HITS] = &SkillBuilder::OnAttackHits;
        ...
        m_builder_table[BUILDER_CONVERT_HEALTH] = &SkillBuilder::OnConvertHealth;
        ...
        m_builder_table[BUILDER_CAST_CONDITION] = &SkillBuilder::OnCastCondition;
    ...
    void SkillBuilder::OnCurse ()
    {
        ...
        m_SkillObj->m_statuses.push_back(status);
    ...
    {
        m_SkillObj->addEffect(SK_DURATION,m_Property.Effects[m_Index]);
    ...
    {
        m_SkillObj->addEffect(SK_KD_BONUS,m_Property.Effects[m_Index]);
    ...
    {
        m_SkillObj->addEffect(SK_KB,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_KB_DIST,m_Property.Effects[m_Index+1]);
    ...
    {
        m_SkillObj->addEffect(SK_KD,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_KD_LEVEL,m_Property.Effects[m_Index+1]);

        m_Index += 2;
    }

    void SkillBuilder::OnAttackHits ()
    {
        //2
        m_SkillObj->addEffect(SK_HIT_COUNT,m_Property.Effects[m_Index+1]);
    ...
    void SkillBuilder::OnHealAmount ()
    {
        ...
        m_SkillObj->addEffect(SK_HP_HEAL,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_MP_HEAL,m_Property.Effects[m_Index+2]);
    ...
    {
        m_SkillObj->addEffect(SK_TARGET_LOCK,true);
    }
    ...
    void SkillBuilder::OnConvertHealth ()
    {
        m_SkillObj->addEffect(SK_HP_CONVERT_RATIO,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_MP_CONVERT_RATIO,m_Property.Effects[m_Index+1]);
    ...
    {
        m_SkillObj->addEffect(SK_AGGRO_DEC,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_AGGRO_DEC_RATIO,m_Property.Effects[m_Index+1]);
    ...
    {
        m_SkillObj->addEffect(SK_REFLECT_MAG,m_Property.Effects[m_Index]);
    ...
    {
        m_SkillObj->addEffect(SK_REFLECT_PHY,m_Property.Effects[m_Index]);
    ...
    {
        m_SkillObj->addEffect(SK_MP_CONSUME_TIME,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_MP_CONSUME,m_Property.Effects[m_Index+1]);
    ...
    {
        m_SkillObj->addEffect(SK_ABSOLUTE_DMG,m_Property.Effects[m_Index]);
    ...
    void SkillBuilder::OnCastCondition ()
    {
        m_SkillObj->addEffect(SK_CAST_CONDITION,m_Property.Effects[m_Index]);
    ...
    void SkillBuilder::OnRequiredWeapon ()
    {
        ...
        case ESS_SHIELD:
            ...
            m_SkillObj->addRequirement(ESS_SHIELD,true);
            break;
        case ESS_WEAPON:
            m_SkillObj->addRequirement(ESS_WEAPON,m_Property.Effects[m_Index+1]);
            break;
        case ESS_ARMOR:
            ///10 and 0 probly required light armor
            m_SkillObj->addRequirement(ESS_ARMOR,m_Property.Effects[m_Index+1]);
            break;
        case ESS_DEVIL:
            ///14 and 1 devil avatar
            m_SkillObj->addRequirement(ESS_DEVIL,true);
            break;
        default:
            break;
        }
    ...
    void SkillBuilder::OnNPCSpawn ()
    {
        ...
        for (int i = 0; i < 9; ++i)
        {
            ...
            m_SkillObj->m_spawns.push_back(info);
        }
    ...
    {
        //500
        m_SkillObj->addEffect(SK_TELEPORT_DIST,m_Property.Effects[m_Index+1]);
    ...
    {
        m_SkillObj->addEffect(SK_AGGRO_INC,m_Property.Effects[m_Index]);
        m_SkillObj->addEffect(SK_AGGRO_INC_RATIO,m_Property.Effects[m_Index+1]);
