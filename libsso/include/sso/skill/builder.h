...
#ifndef __ZELOS_LIBSSO_SSO_SKILL_BUILDER_H__
#define __ZELOS_LIBSSO_SSO_SKILL_BUILDER_H__
...
namespace sso
{
    ...
    protected:
         ...
         *
         *	@build Cast condition to execute the skill.
         *
         **/

        void OnCastCondition ();
...
#endif //__ZELOS_LIBSSO_SSO_SKILL_BUILDER_H__
