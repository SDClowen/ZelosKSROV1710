...
#ifndef __ZELOS_LIBSSO_SSO_SKILL_STATUS_H__
#define __ZELOS_LIBSSO_SSO_SKILL_STATUS_H__
...
namespace sso
{
    ...
    {
        Status ()
            : ID(0), taskID(0), payloadTaskID(0),
            Duration(0), Probability(0), Level(0), Payload(0)
        {}
...
#endif //__ZELOS_LIBSSO_SSO_SKILL_STATUS_H__
