...
#ifndef __ZELOS_LIBSSO_SSO_ENTITY_CHARACTER_STATE_H__
#define __ZELOS_LIBSSO_SSO_ENTITY_CHARACTER_STATE_H__
...
#endif // __ZELOS_LIBSSO_SSO_ENTITY_CHARACTER_STATE_H__
